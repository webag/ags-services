			...
			<div class="tabs__content">
				<div class="tabs__item active">
					<div class="sheme">
						...
						<img src="/img/sheme/on-site.png" alt="Схема On-Site" class="sheme__img">
					</div>
				</div>
				<div class="tabs__item">
					<div class="sheme">
						...
						<img src="/img/sheme/arenda.png" alt="Схема аренды" class="sheme__img">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="grid-6 grid-12_xs">
				<div class="preim">
					...
					<img data-lazy="/img/preims/icon_gas_counter.svg" alt="" class="preim__img">
			...
			<div class="grid-6 grid-12_xs">
				<div class="preim">
					...
					<img data-lazy="/img/preims/icon_container.svg" alt="" class="preim__img">
			...
			<div class="grid-6 grid-12_xs">
				<div class="preim">
					...
					<img data-lazy="/img/preims/icon_remote_control.svg" alt="" class="preim__img">
			...
			<div class="grid-6 grid-12_xs">
				<div class="preim">
					...
					<img data-lazy="/img/preims/icon_saving.svg" alt="" class="preim__img">
			...
			<div class="grid-6 grid-12_xs">
				<div class="preim">
					...
					<img data-lazy="/img/preims/icon_all_inone.svg" alt="" class="preim__img">
			...
			<div class="grid-6 grid-12_xs">
				<div class="preim">
					...
					<img data-lazy="/img/preims/icon_optimize.svg" alt="" class="preim__img">
